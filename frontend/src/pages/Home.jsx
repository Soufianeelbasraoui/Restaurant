    ...
    return (
        <div className="bg-[#fffbf2] min-h-screen text-neutral-dark overflow-hidden m-auto">
                ...
                <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6 pt-4">
                            <Link to="/menu" className="bg-foodie-orange text-white px-10 py-4 rounded-2xl font-bold shadow-lg shadow-foodie-orange/30 hover:scale-105 transition-transform flex items-center space-x-3">
                                <span>Commander Maintenant</span>
                                <ArrowRight size={20} />
                            </Link>
                            <Link to="/about" className="px-10 py-4 rounded-2xl border-2 border-neutral-dark/10 font-bold hover:bg-neutral-dark/5 transition-colors">
                                Notre Histoire
                            </Link>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        {featuredProducts.length > 0 ? featuredProducts.map((product, index) => (
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                                className="bg-white rounded-[10px] p-4 shadow-lg hover:shadow-2xl transition-all border border-neutral-dark/5 group"
                            >
                                <div className="h-64 rounded-[10px] overflow-hidden relative mb-6">
                                    <img 
                                ...
                                <div className="px-4 pb-4 space-y-4">
                                    ...
                                    <button 
                                        ...
                                        className="w-full py-4 bg-neutral-light hover:bg-primary hover:text-white text-primary text-[10px] rounded-xl  transition-colors active:scale-95 duration-200"
                                    >
                                        Ajouter au Panier
                                    </button>
                                </div>
            ...
            <section className="py-24 bg-[#fffbf2]/50 relative overflow-hidden">
                <div className="container mx-auto px-6 relative">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="bg-white p-10 rounded-[10px] shadow-sm hover:shadow-xl transition-all border border-neutral-dark/5 text-center group">
            ...
            <section className="py-24 px-6">
                <div className="container mx-auto bg-neutral-dark rounded-[10px] p-12 md:p-24 text-center text-white relative overflow-hidden group">
                    ...
                    <div className="relative z-10 space-y-10">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            <Link to="/menu" className="bg-foodie-orange text-white px-12 py-5 rounded-2xl font-bold hover:scale-105 transition-transform shadow-xl shadow-foodie-orange/20">
                                Vérifier le Menu
                            </Link>
                            <Link to="/contact" className="px-12 py-5 rounded-2xl border-2 border-white/20 font-bold hover:bg-white/10 transition-colors">
                                Nous Contacter
                            </Link>
                        </div>
                    </div>
